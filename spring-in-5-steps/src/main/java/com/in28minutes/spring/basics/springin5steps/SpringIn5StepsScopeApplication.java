...
//		System.out.println(String.format("%s", personDao));
//		System.out.println(String.format("%s", personDao.getJdbcConnection()));
//		System.out.println(String.format("%s", personDao.getJdbcConnection()));
//		
//		System.out.println(String.format("%s", personDao2));
//		System.out.println(String.format("%s", personDao2.getJdbcConnection()));
